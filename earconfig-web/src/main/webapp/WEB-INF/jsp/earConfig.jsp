...
<html>
	<body>
	    ...
	    <ul>
	        ...
	        <li>Context lookup (JNDI) EJB rétegben (JNDI nevek: earconfig/string, earconfig/url, earconfig/properties): ${contextEjb}</li>
	        <li>System property web rétegben (kulcs: earconfig.system.property): ${systemPropertyWeb}</li>
	        <li>Context lookup (JNDI) web rétegben (JNDI nevek: earconfig/string, earconfig/url, earconfig/properties): ${contextWeb}</li>
	    </ul>
    </body>
